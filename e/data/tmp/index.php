...
<html lang="zh-CN">
	<head>
		...
		<title>
			<?=$public_r[sitename]?> - 四川名人_四川人物介绍_四川省情！
		</title>
		<meta name="description" content="四川人物网是一个以四川人物为主要报道对象的专业性网站，旨在全面展示四川地区各领域优秀人才的风采和事迹，同时传播四川文化、弘扬四川精神。自2010年创立以来，四川人物网不断发展壮大，已经成为了四川地区最具影响力的人物宣传平台之一。" />
		<meta name="keywords" content="四川人物网" />
					...
					<div class="slider-wrap clearfix">
						<div class="main-slider wpcom-slider swiper-container pull-left">
							<ul class="swiper-wrapper">
								...
								<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('1,2,3,4',5,0,1,'firsttitle=1');
if($ecms_bq_sql){
...
?>
								<li class="swiper-slide">
									<a href="<?=$bqsr['titleurl']?>" target="_self">
...
?>
						...
						<ul class="feature-post pull-right">
							<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('1,2,3,4',3,0,1,'firsttitle=2');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
							<li>
								<a href="<?=$bqsr['titleurl']?>" target="_blank">
									<img class="j-lazy" src="<?=$bqr['titlepic']?>" data-original="<?=$bqr['titlepic']?>" alt="<?=$bqr['title']?>" />
								</a> <span><?=$bqr['title']?>
								</span>
							</li>
							<?php
...
?>
					...
					<div class="sec-panel topic-recommend">
						<div class="sec-panel-head">
							<h2>
								...
								</small> <a href="javascript:;" target="_blank" class="more">全部专题
								</a>
							</h2>
						</div>
						<div class="sec-panel-body">
							<ul class="list topic-list">
								<li class="topic">
									<a class="topic-wrap" href="/rw/ysrw/" target="_blank">
										<div class="cover-container">
											<img class="j-lazy" src="skcms/picture/lazy.png" data-original="skcms/picture/1-2201111H941293.png" />
										</div><span>艺术人物
										</span>
									</a>
								</li>
								<li class="topic">
									<a class="topic-wrap" href="/rw/syrw/" target="_blank">
										<div class="cover-container">
											<img class="j-lazy" src="skcms/picture/lazy.png" data-original="skcms/picture/1-2201111H941123.png" />
										</div><span>商业人物
										</span>
									</a>
								</li>
								<li class="topic">
									<a class="topic-wrap" href="/rw/zjrw/" target="_blank">
										<div class="cover-container">
											<img class="j-lazy" src="skcms/picture/lazy.png" data-original="skcms/picture/1-2201111H941433.png" />
										</div><span>政界人物
										</span>
									</a>
								</li>
								<li class="topic">
									<a class="topic-wrap" href="/rw/qtrw/" target="_blank">
										<div class="cover-container">
											<img class="j-lazy" src="skcms/picture/lazy.png" data-original="skcms/picture/1-2201111H941306.png" />
										</div><span>其他人物
										</span>
									</a>
								</li>
					...
					<div class="sec-panel main-list">
						...
						<ul class="post-loop post-loop-default tab-wrap clearfix active">
							...
							<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(1,100,0,1);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
							<li class="item">
								<div class="item-img">
									<a class="item-img-inner" href="<?=$bqsr['titleurl']?>" title="<?=$bqr['title']?>" target="_blank">
										<img class="j-lazy" src="<?=$bqr['titlepic']?>" data-original="<?=$bqr['titlepic']?>" width="480" height="300" alt="<?=$bqr['title']?>" />
									</a> <a class="item-category" href="<?=$bqsr[classurl]?>" target="_self"><?=$class_r[$bqr[classid]][classname]?></a>
								</div>
								<div class="item-content">
									...
									<div class="item-meta">
										...
										</span> <span class="item-meta-li views" title="<?=$bqr['title']?>">
											<i class="fa fa-eye"></i> <?=$bqr[onclick]?>
										</span>
									</div>
								</div>
							</li>
				...
				<div class="sec-panel">
					<div class="sec-panel-head">
						<h2>
							<span>
								友情链接
							</span> <small>百度权重≥5符合友链交换
							</small> <a href="javascript:;" target="_self" class="more">申请友链
							</a>
						</h2>
					</div>
					<div class="sec-panel-body">
