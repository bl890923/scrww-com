...
<title>舜王网站管理系统轻盈版</title>
<link rel="stylesheet" href="loginimg/css.css" type="text/css">
<base onmouseover="window.status='舜王网站管理系统轻盈版';return true">
<script>
if(self!=top)
{
    ...
    <td align="center" valign="middle" style="padding:100px 0 0 0;"><table width="455" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <tr> 
            ...
            <td colspan="2"> <input name="username" type="text" class="input1" value="admin" size="24"> 
            </td>
          </tr>
          <tr> 
            <td height="40">密　码：</td>
            <td colspan="2"> <input name="password" type="password" class="input1" value="admin" size="24"> 
            </td>
          </tr>
		  <?php
...
成都舜王科技有限公司
</a>   版本号：<a href="http://www.shunking.cn" target="_blank">CMS V7.5 AIR</a>
            </td>
