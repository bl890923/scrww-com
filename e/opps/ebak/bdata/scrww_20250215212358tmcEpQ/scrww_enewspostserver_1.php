...
E_D("DROP TABLE IF EXISTS `scrww_enewspostserver`;");
E_C("CREATE TABLE `scrww_enewspostserver` (
...
E_D("replace into `scrww_enewspostserver` values('1',0xe99984e4bbb6e69c8de58aa1e599a8,'','1','','','','','','0','0','0','0','0');");
