...
E_D("DROP TABLE IF EXISTS `scrww_enewsmoreport`;");
E_C("CREATE TABLE `scrww_enewsmoreport` (
...
E_D("replace into `scrww_enewsmoreport` values('1',0xe4b8bbe8aebfe997aee7abaf,'','','','','0','0','0','0','','0','0');");
