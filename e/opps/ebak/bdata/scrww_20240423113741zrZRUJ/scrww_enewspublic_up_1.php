...
E_D("DROP TABLE IF EXISTS `scrww_enewspublic_up`;");
E_C("CREATE TABLE `scrww_enewspublic_up` (
...
E_D("replace into `scrww_enewspublic_up` values('1','1355124469','1355124476','168','0',0x7c312c3136387c,'','1707990400','1707990400','2','0','0','0');");
