...
E_D("DROP TABLE IF EXISTS `scrww_enewsclass_stats_set`;");
E_C("CREATE TABLE `scrww_enewsclass_stats_set` (
...
E_D("replace into `scrww_enewsclass_stats_set` values('0','3600','0','20170227');");
