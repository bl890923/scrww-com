                  ...
                  <TR align=middle> 
                    <TD width=60 onMouseOver="if(document.menuform.onclickmenu.value!='dosysmenu'){this.style.backgroundColor='#e2e2e2';}" onMouseOut="if(document.menuform.onclickmenu.value!='dosysmenu'){this.style.backgroundColor='';}" onClick="DoOnclickMenu('dosysmenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=system<?=$ecms_hashur['ehref']?>');" style="CURSOR: hand" id="dosysmenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr> 
                          <td height="20">
<div align="center"><font color="#3c434c">核心</font></div></td>
                        </tr>
                      </table></TD>
...
<div align="center"><font color="#3c434c">用户</font></div></td>
                    ...
                    <TD style="CURSOR: hand" id="dotoolmenu">&nbsp;</TD>
					<TD width=60 onMouseOut="if(document.menuform.onclickmenu.value!='doshopmenu'){this.style.backgroundColor='';}" onMouseOver="if(document.menuform.onclickmenu.value!='doshopmenu'){this.style.backgroundColor='#e2e2e2';}" onClick="DoOnclickMenu('doshopmenu');window.open('/','AdminShopSys','');" style="CURSOR: hand;<?=$showshopmenu?'':'display:none'?>" id="doshopmenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
                          <td><div align="center"><IMG height=32 src="adminstyle/1/images/shop<?=$menufiletype?>" width=32 border=0 title="网站首页"></div></td>
                        </tr>
                        <tr> 
                          <td height="20">
<div align="center"><font color="#3c434c">首页</font></div></td>
                        </tr>
                      </table></TD>
                    <TD style="CURSOR: hand" id="doothermenu"></TD>
				    <TD style="CURSOR:hand;<?=$showextmenu?'':'display:none'?>" id="doextmenu"> </TD>
                    <TD style="CURSOR:hand;<?=$showfastmenu?'':'display:none'?>" id="dofastmenu"></TD>
                  </TR>
                </TBODY>
              </TABLE>
        ...
        <TD class=flyoutMenu width="220"><img src="adminstyle/1/images/a1.gif" border="0"></TD>   
		    <TD width="77%" height="33"> 
              <TABLE border=0 cellpadding="0" cellspacing="0" class=flyoutMenu>
                <TBODY>
                  <TR align=middle> 
                    <TD width="60" class="flyoutLink" onClick="JumpToMain('AddInfoChClass.php<?=$ecms_hashur['whehref']?>');" onMouseOver="over(this)" onMouseOut="out(this)">&nbsp;</TD>
