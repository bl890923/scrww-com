...
function addpic(){
	...
	{
		str=str+"<tr onmouseout=this.style.backgroundColor='#ffffff' onmouseover=this.style.backgroundColor='#e0e5ec'><td width='8%'><div align=center>"+i+"</div></td><td width='92%'> <div align=center><input name=file[] type=file style='width:100%;FONT-SIZE:12px;' onmouseover=this.focus()></div></td></tr>";
	}
...
function EcmsEditorChangeSet(cset){
	if(cset==2)
	{
		...
		document.getElementById('etranmore_tab_bg2').style.backgroundColor="#e5e8eb";
	...
	else if(cset==3)
	{
		...
		document.getElementById('etranmore_tab_bg3').style.backgroundColor="#e5e8eb";
		document.getElementById('etranmore_tab_bg4').style.backgroundColor="#ffffff";
	}
	else if(cset==4)
	{
		...
		document.getElementById('etranmore_tab_bg2').style.backgroundColor="#ffffff";
		document.getElementById('etranmore_tab_bg3').style.backgroundColor="#ffffff";
		document.getElementById('etranmore_tab_bg4').style.backgroundColor="#e5e8eb";
	}
	else
	{
		...
		document.getElementById('etranmore_tab_bg1').style.backgroundColor="#e5e8eb";
		document.getElementById('etranmore_tab_bg2').style.backgroundColor="#ffffff";
		document.getElementById('etranmore_tab_bg3').style.backgroundColor="#ffffff";
		document.getElementById('etranmore_tab_bg4').style.backgroundColor="#ffffff";
	}
...
<tr>
<td width="25%" id="etranmore_tab_bg1" onmouseover="EcmsEditorChangeSet(1);" style="text-align:center;background-color:#e5e8eb;"><strong>本地上传</strong></td>
