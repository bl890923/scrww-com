...
//------------e_public
\$public_r=array(
'sitename'=>'".addslashes($r[sitename])."',
'fwrx'=>'".addslashes($r[fwrx])."',
'lxdh'=>'".addslashes($r[lxdh])."',
'kfqq'=>'".addslashes($r[kfqq])."',
'kfyx'=>'".addslashes($r[kfyx])."',
'gsdz'=>'".addslashes($r[gsdz])."',
'icp'=>'".addslashes($r[icp])."',
'tjdm'=>'".addslashes($r[tjdm])."',
