            ...
            var h = e.bShareUtil = {
                    ...
                    eleInViewport: function(a)
                    {
                        if (a.getBoundingClientRect)
                            return a = a.getBoundingClientRect(), a.top >= 0 && a.left >= 0 && a.bottom <= (e.innerHeight || l.clientHeight) && a.right <= (e.innerWidth || l.clientWidth);
                ...
                stopProp: function(a)
                {
                    ...
                    createBuzzObject: function(a, b)
                    {
                        ...
                        c.config = {};
                            c.elems = { powerBy: '<div id="bsPower" style="float:right;text-align:right;overflow:hidden;height:100%;"><a class="bsSiteLink" style="font-size:10px;vertical-align:text-bottom;line-height:24px;cursor:pointer;" href="' + c.whost + '" target="_blank"><span style="font-size:10px;vertical-align:text-bottom;"><span style="color:#f60;">b</span>Share</span></a></div>' };
                        ...
                        parseBuzzOptions: function(a, b, c, f, k)
                        {
                            ...
                            i = (a = h.getScript(b)[a]) ? h.parseOptions(a.src) : {},
                                ...
                                k && (a = k(a));
                                for (var d in a)
                                    if (!h.isUndefined(a[d]) && !(a[d] === null || typeof c[d] == "number" && a[d] === ""))
                ...
                a.loadButtonStyle = function()
                {
                    if (c.type != 15)
                    {
                        var f,
                            e = b.style;
                        if (b.beta)
                            f = a.jsBasePath + "styles/bshareS888.js?v=20150603";
                        else if (b.popjs)
                            f = b.popjs;
                        else if (b.style != -1 && (f = a.jsBasePath + "styles/bshareS" + (e > 1 && e < 6 ? e : 1) + ".js?v=20150603", b.pop == -1 && (e <= 1 || e >= 6)))
                            f = "";
                        f && d.loadScript(f)
                    }
                };
