...
var B = !1,
    ...
    config: function(e)
    {
        ...
        {
            if (n)
                i(g.config, { verifyJsApiList: d(A.jsApiList) }, function()
                {
    ...
    {
        t(g.onMenuShareTimeline, { complete: function()
            {
                i("shareTimeline", {
                    title: e.title || y,
                    desc: e.title || y,
    ...
    {
        t(g.onMenuShareAppMessage, { complete: function(n)
            {
    ...
    {
        t(g.onMenuShareQQ, { complete: function()
            {
                i("shareQQ", {
                    title: e.title || y,
                    desc: e.desc || "",
    ...
    {
        t(g.onMenuShareWeibo, { complete: function()
            {
                i("shareWeiboApp", {
                    title: e.title || y,
                    desc: e.desc || "",
    ...
    {
        t(g.onMenuShareQZone, { complete: function()
            {
                i("shareQZone", {
                    title: e.title || y,
                    desc: e.desc || "",
    ...
    startRecord: function(e)
    {
        ...
        stopRecord: function(e)
        {
            ...
            getNetworkType: function(e)
            {
                ...
                {
                    e = e || {},
                        i(g.getLocation, { type: e.type || "wgs84" }, (e._complete = function(e)
                        {
                            delete e.type
                        }, e))
                    },
